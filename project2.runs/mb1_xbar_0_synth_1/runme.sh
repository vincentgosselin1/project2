...
HD_PWD='C:/Xilinx/Vivado/2021.1/myDev/project2/project2.runs/mb1_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb1_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb1_xbar_0.tcl
