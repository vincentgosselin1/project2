...
HD_PWD='C:/Xilinx/Vivado/2021.1/myDev/project2/project2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb1_wrapper.tcl
